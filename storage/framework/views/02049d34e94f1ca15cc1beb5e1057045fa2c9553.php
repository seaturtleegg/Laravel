					...
					<form id="myform" name="form" method="post" class="form-horizontal" role="form" action="searchWO">
						...
						<div class="form-group col-md-5">
							...
							<div class="col-md-6">
									...
									<option value="0"></option>
									<<?php $__currentLoopData = $woStatus; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $status): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
									<?php echo e($status->Name); ?>

									<option value="<?php echo e($status->Id); ?>" data-id="<?php echo e($status->Id); ?>"><?php echo e($status->Name); ?></option> 
					...
					<form id="myform2" name="form" method="post" class="form-horizontal" role="form" action="editwo">
							...
							<table class="table" id ="workOrderInfo">
								...
								<tbody>
									...
									<option id="selectedStatus<?php echo $count;?>" selected="seleted<?php echo $count;?>"  value="<?php echo e($workOrder->StatusId); ?>"><?php echo e($workOrder->StatusName); ?></option>
									<option value="0"></option>
									<<?php $__currentLoopData = $woStatus; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $status): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
									<?php echo e($status->Name); ?>
			...
			<div class="col-md-8 column">
				<h4><label>国内订单详情</label></h4>
							...
							<div class="form-group">
								...
								<div class="col-sm-8">
									<select class="form-control" name="woCategory" id="woCategory<?php echo $index;?>" value="<?php echo e($workOrder->WOCategoryId); ?>" disabled> 
									<option id="selectedWOCategory<?php echo $index;?>" selected="seleted"  value="<?php echo e($workOrder->WOCategoryId); ?>"><?php echo e($workOrder->WOCategoryName); ?></option>
									<option value="0"></option>
							...
							<div class="form-group">
								...
								<div class="col-sm-8">
									<input type="text" class="required form-control" value="<?php echo e($workOrder->CreateDate); ?>" disabled />
								</div>
							</div>
							<div class="form-group">
							...
							<div class="form-group">
								...
								<div class="col-sm-8">
									<input type="text" class="required form-control" id="weight<?php echo $index;?>" name="weight" value="<?php echo e($workOrder->Weight); ?>" disabled />
								</div>
							</div>
						...
						<h4><label>寄件人信息</label></h4>
							...
							<div class="form-group">
								...
								<div class="col-sm-8">
									<input type="text" class="required form-control" id="senderName<?php echo $index;?>" name="senderName" value="<?php echo e($workOrder->SenderName); ?>" disabled />
								</div>
							</div>
							<div class="form-group">
								<p for="text" class="col-sm-4 control-label">寄件人电话<font color="red">*</font></p>
								<div class="col-sm-8">
									<input type="text" class="required form-control" id="senderPhone<?php echo $index;?>" name="senderPhone" value="<?php echo e($workOrder->SenderPhoneNumber); ?>" disabled />
								</div>
							</div>
							<div class="form-group">
								<p for="text" class="col-sm-4 control-label">寄件人地址<font color="red">*</font></p>
								<div class="col-sm-8">
									<input type="text" class="required form-control" id="senderAddress<?php echo $index;?>" name="senderAddress" value="<?php echo e($workOrder->SenderAddress); ?>" disabled />
								</div>
							</div>
						<h4><label>收件人信息</label></h4>
							...
							<div class="form-group">
								...
								<div class="col-sm-8">
									<input type="text" class="required form-control" id="receiverName<?php echo $index;?>" name="receiverName" value="<?php echo e($workOrder->ReceiverName); ?>" disabled />
								</div>
							</div>
							<div class="form-group">
								<p for="text" class="col-sm-4 control-label">收件人电话<font color="red">*</font></p>
								<div class="col-sm-8">
									<input type="text" class="required form-control" id="receiverPhone<?php echo $index;?>" name="receiverPhone" value="<?php echo e($workOrder->ReceiverPhoneNumber); ?>" disabled />
								</div>
							</div>
							<div class="form-group">
								<p for="text" class="col-sm-4 control-label">收件人地址<font color="red">*</font></p>
								<div class="col-sm-8">
									<input type="text" class="required form-control" id="receiverAddress<?php echo $index;?>" name="receiverAddress" value="<?php echo e($workOrder->ReceiverAddress); ?>" disabled />
								</div>
							</div>
							<div class="form-group">
								...
								<div class="col-sm-8">
									...
									<option id="selectedState<?php echo $index;?>" selected="seleted"  value="<?php echo e($workOrder->StateId); ?>"><?php echo e($workOrder->StateId); ?></option>
									<option value="0"></option>
							...
							<div class="form-group">
								...
								<div class="col-sm-8">
									<select class="form-control" name="city" id="city<?php echo $index;?>" value="<?php echo e($workOrder->CityId); ?>" disabled >
									<option selected="seleted"  value="<?php echo e($workOrder->CityId); ?>"><?php echo e($workOrder->CityId); ?></option>
									<option value="0"></option>
									</select> 
								</div>
							</div>
							<div class="form-group">
								...
								<div class="col-sm-8">
									<input type="text" class="required form-control" id="zipCode<?php echo $index;?>" name="zipCode" value="<?php echo e($workOrder->ZipCode); ?>" disabled />
								</div>
							</div>
							<div class="form-group">
								<p for="text" class="col-sm-4 control-label">收件人邮箱<font color="red">*</font></p>
								<div class="col-sm-8">
									<input type="text" class="required form-control" id="email<?php echo $index;?>" name="email" value="<?php echo e($workOrder->ReceiverEmail); ?>" disabled />
								</div>
							</div>
							<div class="form-group">
								<p for="text" class="col-sm-4 control-label">邮寄货品描述<font color="red">*</font></p>
								<div class="col-sm-8">
									<input type="text" class="required form-control" id="description<?php echo $index;?>" name="description"value="<?php echo e($workOrder->Description); ?>" disabled />
								</div>
							</div>
